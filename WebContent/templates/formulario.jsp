		 	...
		 	<form action="#" method="post">
		 		<div class="row">
		 			<div class="form-group col-md-6">
		 				...
		 				<input type="text" class="form-control" id="campo1" id="campo1" placaholder="Digite o campo 1">	
		 			</div>
		 		</div>
		 		...
		 		<div class="row">
		 			<div class="form-group col-md-6">
		 				...
		 				<input type="text" class="form-control" id="campo2" id="campo1" placaholder="Digite o campo 2">	
		 			</div>
		 		</div>
